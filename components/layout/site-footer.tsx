...
function NewsletterBlock() {
  return (
    <div className="relative mx-auto flex w-full max-w-[1200px] flex-col items-center justify-center overflow-hidden rounded-[32px] border border-[#00000c] bg-[linear-gradient(1.35deg,#050517_3.37%,#00000c_101.31%)] px-4 pb-8 pt-8 sm:px-6 lg:h-[384px] lg:rounded-[52px] lg:px-[25px] lg:pb-[35px] lg:pt-[25px]">
      <img
      ...
      />
      <div className="relative z-10 flex w-full flex-col items-center gap-8 lg:gap-12">
        <div className="flex w-full flex-col items-center gap-[22px]">
          ...
          <SectionHeading
            ...
            className="w-full max-w-[540px] text-center text-[34px] leading-[1.05] sm:text-[42px] lg:text-[48px] lg:leading-[52px]"
            line2ClassName="mt-1"
          />
        </div>

        <form className="flex h-[52px] w-full max-w-[640px] items-center gap-2 rounded-[112px] border border-[rgba(243,243,243,0.08)] bg-[rgba(10,10,33,0.76)] pl-4 pr-[9px]">
          <input
            type="email"
            placeholder={footerCopy.newsletterPlaceholder}
            className="h-full min-w-0 flex-1 bg-transparent text-sm leading-5 text-white placeholder:text-white focus:outline-none"
          />
          <button
            type="submit"
            className="inline-flex h-[38px] items-center justify-center rounded-[140px] bg-[#2424a6] px-6 text-base capitalize text-white"
          >
        ...
        <section className="relative mt-[72px] overflow-hidden border-t border-[#5050ff] px-4 pb-[72px] pt-[72px] sm:px-8 lg:min-h-[532px] lg:px-[120px]">
          ...
          <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-12 lg:gap-[72px]">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-3 md:gap-10 lg:gap-[170px]">
              <div className="flex flex-col gap-8">
                <div className="relative">
                  ...
                  <img
                    ...
                    className="relative z-10 h-[84px] w-[460px] object-contain object-left lg:h-[92px] lg:w-[520px]"
                  />
                </div>
              ...
              <div className="flex flex-col gap-8">
                <h3 className="text-[22px] font-bold capitalize leading-5 text-white">
              ...
              <div className="flex flex-col gap-8">
                <h3 className="text-[22px] font-bold leading-5 text-white">
