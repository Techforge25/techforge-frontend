        ...
        <SectionPaddingY72 className="py-14 sm:py-[72px]">
          <div className="relative z-10 mx-auto w-full max-w-[960px] rounded-[24px] border border-[#272835] bg-[#121324] px-6 py-12 text-center sm:px-12 sm:py-16">
            <div className="flex flex-col items-center gap-6">
              <SectionBadge label="don't see your role?" className="h-[28px] border border-[rgba(255,255,255,0.15)] px-[11px] py-0 text-sm leading-none" />
              
              <SectionHeading
                line1="We're Always Interested In Meeting People"
                line2Highlight="Who Think Deeply"
                line2After=""
              ...
              <p className="max-w-[580px] text-sm leading-relaxed text-[#cac6dd] sm:text-base">
                We&apos;re always interested in meeting people who think deeply, build carefully, and aren&apos;t afraid to challenge assumptions.
              </p>
