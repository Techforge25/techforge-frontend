...
export default function PortfolioDetailHeroSection({ portfolio }: PortfolioDetailHeroSectionProps) {
  return (
    <section className="relative h-[743px] w-full overflow-hidden bg-[#00000c]">
      <img
        src={portfolio.heroImage}
        alt={`${portfolio.projectName} project mockup`}
      ...
      <div className="absolute left-1/2 top-[54px] z-10 -translate-x-1/2 rounded-[140px] border border-[rgba(36,138,255,0.6)] bg-[linear-gradient(81.02deg,rgba(231,61,196,0.66)_15.78%,rgba(9,14,219,0.66)_102.06%)] px-[11px] py-[10px]">
        <div className="flex items-center gap-[6px]">
          ...
          <p className="font-['Manrope',sans-serif] text-2xl font-normal lowercase leading-8 text-white">
            {portfolio.heroBadgeLabel}
          </p>
        </div>
      </div>
    </section>
