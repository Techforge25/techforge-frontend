...
function OverviewItem({
  ...
  return (
    <article className={`rounded-2xl border border-[#272835] p-[22px] ${className}`}>
      <div className="space-y-[22px]">
        <div className="space-y-5">
          ...
          <div className="space-y-3">
            <h3 className="text-[30px] font-medium leading-7 text-[#eeeff2]">{title}</h3>
            {children}
          </div>
        </div>
      </div>
...
function deriveAssumption(portfolio: PortfolioDetail) {
  return (
    portfolio.assumption ??
    `The founder initially believed that solving the core ${portfolio.category.toLowerCase()} workflow with a focused digital product would create faster clarity, better visibility, and a stronger path to growth.`
  );
}

function deriveDecision(portfolio: PortfolioDetail) {
  return portfolio.decision ?? portfolio.solutionDescription;
}
    ...
    <section className="relative overflow-hidden bg-[#00000c] px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-[72px]">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1200px] space-y-[56px]">
        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
          ...
          >
            <div className="space-y-3">
              <p className="text-sm leading-[17px] text-[#cac6dd]">What problem did the founder have?</p>
              <div className="space-y-3">
          ...
          >
            <div className="space-y-3">
              <p className="text-sm leading-[17px] text-[#cac6dd]">What did they initially believe?</p>
              <p className="text-sm leading-[17px] text-[#cac6dd]">{deriveAssumption(portfolio)}</p>
            </div>
          </OverviewItem>
          ...
          >
            <div className="space-y-3">
              <p className="text-sm leading-[17px] text-[#cac6dd]">What did TechForge recommend?</p>
              <p className="text-sm leading-[17px] text-[#cac6dd]">{deriveDecision(portfolio)}</p>
            </div>
          </OverviewItem>
          ...
          >
            <div className="space-y-3">
              <p className="text-sm leading-[17px] text-[#cac6dd]">What did we actually build?</p>
